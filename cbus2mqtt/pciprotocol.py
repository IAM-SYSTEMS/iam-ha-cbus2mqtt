...
class PCIProtocol(CBusProtocol):
    ...
    def __init__(
        ...
        # Confirm-and-wait TX queue (IAM fork). One confirmed packet in flight.
    ...
    def connection_made(self, transport: WriteTransport) -> None:
        ...
        logger.warning(
            'cbus tx-queue confirm-and-wait active '
            '(1 in flight, 1 retry)')
        self.pci_reset()
